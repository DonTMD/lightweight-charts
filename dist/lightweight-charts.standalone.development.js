/*!
 * @license
 * TradingView Lightweight Charts™ v5.1.0-dev+202602170659
...
(function () {
    ...
    const barStyleFnMap = {
        ...
        BrokenArea: (findBar, brokenAreaStyle, barIndex, precomputedBars) => {
            const currentBar = ensureNotNull(findBar(barIndex, precomputedBars));
            return {
                _internal_barColor: currentBar._internal_color ?? brokenAreaStyle.color,
    ...
    function isFulfilledCloudAreaData(data) {
        return data.lowerValue !== undefined;
    }
    ...
    const createPaneView$8 = (series, model, customPaneView) => {
    ...
    const createCustomSeriesDefinition = (paneView) => {
        const definition = {
             ...
             * @internal
             */
            _internal_createPaneView: createPaneView$8,
    ...
    const createPaneView$7 = (series, model) => new SeriesLinePaneView(series, model);
    ...
    const createPaneView$6 = (series, model) => new SeriesBaselinePaneView(series, model);
    const createSeries$6 = () => {
        const definition = {
            type: 'Baseline',
            isBuiltIn: true,
    ...
    const baselineSeries = createSeries$6();
    ...
    const createPaneView$5 = (series, model) => new SeriesAreaPaneView(series, model);
    ...
    const areaSeries = createSeries$5();
    ...
    const createPaneView$4 = (series, model) => new SeriesBarsPaneView(series, model);
    ...
    const barSeries = createSeries$4();
    ...
    const createPaneView$3 = (series, model) => new SeriesCandlesticksPaneView(series, model);
    ...
    const candlestickSeries = createSeries$3();
    ...
    const createPaneView$2 = (series, model) => new SeriesHistogramPaneView(series, model);
    ...
    const histogramSeries = createSeries$2();
    ...
    const createPaneView$1 = (series, model) => new SeriesBrokenAreaPaneView(series, model);
    ...
    const brokenAreaSeries = createSeries$1();
    ...
    const createPaneView = (series, model) => new SeriesCloudAreaPaneView(series, model);
    const createSeries = () => {
        const definition = {
            type: 'CloudArea',
            isBuiltIn: true,
    ...
    const cloudAreaSeries = createSeries();
    ...
    var LightweightChartsModule = /*#__PURE__*/Object.freeze({
        ...
        BrokenAreaSeries: brokenAreaSeries,
        CandlestickSeries: candlestickSeries,
        CloudAreaSeries: cloudAreaSeries,
